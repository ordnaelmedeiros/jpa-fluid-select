...
public interface OperationBetween<ObjBack, SelectTable, Type> extends OperationBase<ObjBack, SelectTable, Type> {
	 ...
	 * @return back
	 */
	default Operations<ObjBack,SelectTable> between(Type value1, Type value2) {
	 ...
	 * @return back
	 */
	default Operations<ObjBack,SelectTable> between(FieldRef<?> field1, FieldRef<?> field2) {
	 ...
	 * @return back
	 */
	default Operations<ObjBack,SelectTable> between(Type value1, FieldRef<?> field2) {
	 ...
	 * @return back
	 */
	default Operations<ObjBack,SelectTable> between(FieldRef<?> field1, Type value2) {
